...
CORS_ORIGINS=https://arivu.app,https://www.arivu.app

# Multiple environments
CORS_ORIGINS=https://arivu.app,https://staging.arivu.app,http://localhost:3000
```
...
# Production
REACT_APP_BACKEND_URL=https://api.arivu.app
```
